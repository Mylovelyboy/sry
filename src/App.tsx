...
//             />
//             <p className="text-gray-700 font-comic text-center">
//               😭yar please itna try karaha hu maff karde aab too pls 🙂🤗
//             </p>
//           </div>
//         </div>
...
//                   <p> Dear Madam, I'm really sorry I was not able to text you during this period. I know it felt like I was ignoring you, but that wasn't my intention at all😭. </p>

//                   <p>The truth is, I missed you soooooooooooooo, soooooooooooooo much while I was away.I still miss u and not being able to talk to you was the hardest part 😭😭.</p>

//                   <p>smokey From now on, I promise to make it up to you. I'll do everything in my power to stay in touch, no matter what.... Whether I'm in a different city, country, or even just busy with work or school, you'll always be my priority.😶‍🌫️ I'll make sure to text  you regularly, so you never feel ignored or forgotten again.💯😭</p>
    ...
    >
      ...
      <div className={`max-w-4xl mx-auto space-y-8 ${showContent ? 'animate-fade-in' : 'opacity-0'}`}>
        <div className="text-center">
          ...
          <p className="text-gray-600 font-comic">Thak gya hu ab mai aap se bina baat kare .</p>
        </div>
            ...
            <div className="bg-white bg-opacity-95 p-6 rounded-lg shadow-xl">
              ...
              <div className="prose max-w-none">
                ...
                <div className="space-y-3 font-comic text-gray-700 leading-relaxed">
                  ...
                  <p>
                    I regret not being there when you needed me most and for the moments lost due to my thoughtlessness. Your feelings matter to me the most .
                  </p>
                  <p>
                    Please forgive me for my mistakes. I promise to learn, to grow, and to always cherish our bond. Let this apology be the first step toward healing and rebuilding the trust we once shared.Sounds crazzy but thats the truth
                  </p>
                  <p className="text-right font-bold mt-4">
                    Yours sincerely,<br />
                    Idiot
